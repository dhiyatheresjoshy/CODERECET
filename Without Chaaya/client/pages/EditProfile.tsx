              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {skillsToTeach.map((skill) => (
                    <Badge 
                      key={skill} 
                      className="bg-gradient-to-r from-cyber-neon/20 to-cyber-blue/20 text-cyber-neon border border-cyber-neon/30 hover:shadow-lg hover:shadow-cyber-glow-neon transition-all pr-1"
                    >
                      {skill}
                      <Button
                        type="button"
