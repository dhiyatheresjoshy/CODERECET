      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="bg-cyber-card border border-cyber-border shadow-xl hover:border-cyber-neon/50 transition-all">
            <CardHeader className="pb-3">
              <CardTitle className="text-cyber-text flex items-center gap-2">
                <Users className="w-5 h-5 text-cyber-neon" /> Exchanges
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="bg-cyber-card border border-cyber-border shadow-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold text-cyber-text mb-2 flex items-center gap-2">
                  <Target className="w-4 h-4 text-cyber-purple" /> I want to learn:
                </h4>
                <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" className="w-full border-cyber-blue text-cyber-blue hover:bg-cyber-blue hover:text-white hover:shadow-lg hover:shadow-cyber-glow-blue transition-all" onClick={() => navigate('/edit-profile')}>
                Edit Profile
              </Button>
            </CardContent>
          </Card>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Button variant="outline" className="h-20 flex-col border-cyber-blue text-cyber-blue hover:bg-cyber-blue hover:text-white hover:shadow-lg hover:shadow-cyber-glow-blue transition-all" onClick={() => navigate('/messages')}>
            <MessageCircle className="w-6 h-6 mb-1" /> Messages
          </Button>

          <Button variant="outline" className="h-20 flex-col border-cyber-purple text-cyber-purple hover:bg-cyber-purple hover:text-white hover:shadow-lg hover:shadow-cyber-glow-purple transition-all" onClick={() => navigate('/my-exchanges')}>
            <Users className="w-6 h-6 mb-1" /> My Exchanges
          </Button>

          <Button variant="outline" className="h-20 flex-col border-cyber-neon text-cyber-neon hover:bg-cyber-neon hover:text-cyber-dark hover:shadow-lg hover:shadow-cyber-glow-neon transition-all" onClick={() => navigate('/leaderboard')}>
            <Trophy className="w-6 h-6 mb-1" /> Leaderboard
          </Button>

          <Button variant="outline" className="h-20 flex-col border-cyber-purple text-cyber-purple hover:bg-cyber-purple hover:text-white hover:shadow-lg hover:shadow-cyber-glow-purple transition-all" onClick={() => navigate('/settings')}>
